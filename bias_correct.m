function bias_correct(files,spm_path,window_size,sphere_size_for_brain_mask,include_c3)
    addpath(spm_path)
    files
    matlabbatch{1}.spm.spatial.preproc.channel.vols = {[files ',1']};
    matlabbatch{1}.spm.spatial.preproc.channel.biasreg = 0.001;
    matlabbatch{1}.spm.spatial.preproc.channel.biasfwhm = window_size;
